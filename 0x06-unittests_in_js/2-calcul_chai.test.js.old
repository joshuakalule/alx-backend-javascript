...
describe('tests the method calculateNumber', function () {
  ...
  describe('test when type is DIVIDE', function () {
    ...
    it('tests when b rounds to zero', function () {
      expect(calculateNumber('DIVIDE', 10.2, 0.3)).to.equal('Error');
      expect(calculateNumber('DIVIDE', 10.2, -0.2)).to.equal('Error');
      expect(calculateNumber('DIVIDE', 10.2, 0)).to.equal('Error');
      expect(calculateNumber('DIVIDE', 10.2, -0)).to.equal('Error');
    });
  });
});
